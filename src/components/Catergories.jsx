...
const Catergories = () => {
    return (
        <div className='w-full bg-[#F0FBF7] py-24 px-5'>
            <div className='lg:max-w-[1025px] m-auto max-w-[600px]  px-4 md:px-0'>
                <h1 className='md:leading-[72px] text-2xl lg:text-3xl font-bold'>
                    Most <span className='text-[#2863bb]'>Popular Categories</span>
                </h1>
                
                <p className='lg:text-lg text-base text-gray-800'>
                    Various versions have evolved over the years, sometimes by accident.
                </p>
                    
                <div className='grid lg:grid-cols-3 grid-cols-2 py-12 lg:gap-8 gap-3'>
